...
export const canisterId = process.env.ICRC7_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icrc7.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icrc7 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icrc7.did.js")._SERVICE>}
 */
export const icrc7 = createActor(canisterId);
